...
ApplicationWindow {
	...
	ListModel {
		id: modeModel
		ListElement { key: "4x4";   title: "4×4";   subtitle: "经典模式 / 2D"; dims: 2; size: 4; depth: 1 }
		ListElement { key: "6x6";   title: "6×6";   subtitle: "进阶模式 / 2D"; dims: 2; size: 6; depth: 1 }
		ListElement { key: "8x8";   title: "8×8";   subtitle: "硬核模式 / 2D"; dims: 2; size: 8; depth: 1 }
		ListElement { key: "4x4x4"; title: "4×4×4"; subtitle: "立体模式 / 3D"; dims: 3; size: 4; depth: 4 }
		ListElement { key: "6x6x6"; title: "6×6×6"; subtitle: "立体模式 / 3D"; dims: 3; size: 6; depth: 6 }
		ListElement { key: "8x8x8"; title: "8×8×8"; subtitle: "立体模式 / 3D"; dims: 3; size: 8; depth: 8 }
	}
	...
	Rectangle {
		...
		gradient: Gradient {
			...
			GradientStop { position: 1.0; color: "#060912" }
		}
	}
			...
			ColumnLayout {
				...
				ListView {
					...
					delegate: Rectangle {
						...
						HoverHandler { id: hover; onHoveredChanged: tile.hovered = hovered }
						...
						Rectangle {
							...
							gradient: Gradient {
								GradientStop { position: 0.0; color: tile.hovered ? "#131d34" : "#0f172a" }
								GradientStop { position: 1.0; color: tile.hovered ? "#0b1223" : "#0a1020" }
							}
							opacity: 0.95
						}
										...
										ColumnLayout {
											...
											RowLayout {
												...
												Rectangle {
													...
													Text { anchors.centerIn: parent; text: "—"; color: "#e5e7eb"; font.pixelSize: 14 }
												}
												Rectangle {
													radius: 12
													color: "#111827"
							...
							Item {
								...
								Rectangle {
									...
									ColumnLayout {
										...
										Text {
											Layout.fillWidth: true
											text: (boardLoader.errorString !== undefined && boardLoader.errorString !== null)
												? String(boardLoader.errorString)
												: ""
